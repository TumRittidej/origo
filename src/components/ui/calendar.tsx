...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      classNames={{
        root: cn(
          'w-fit !bg-primary rounded-md !border-0 !shadow-none',
        ...
        day: cn(
          'relative w-full h-full p-0 !border-0 !outline-none text-center [&:last-child[data-selected=true]_button]:rounded-r-md group/day aspect-square select-none',
