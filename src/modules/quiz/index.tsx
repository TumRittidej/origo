    ...
    <div className="mx-auto flex min-h-screen w-full max-w-2xl flex-col justify-center px-5 py-10">
      {showInterstitial ? (
        <div key={current.id} className="animate-fade-in-up">
          <div className="relative flex bg-primary w-full flex-col gap-6 rounded-3xl border border-secondary-color p-10 shadow-[0_0_40px_rgba(255,179,71,0.15)] hover:shadow-[0_0_60px_rgba(255,179,71,0.25)] transition-all duration-500">
            <Button
              variant="default"
              size="icon"
              onClick={() => {
              ...
              className="absolute -top-6 rounded-full p-6 left-1/2 -translate-x-1/2 right-[50%]"
            >
              <MdOutlineElectricBolt size={28} />
            </Button>
          ...
          <div className="flex justify-center pt-8">
            <Button
              ...
              className="rounded-full p-6 animate-scale-pop cursor-pointer"
            >
                          ...
                          {current.options!.map((opt) => {
                            ...
                            return (
                              <div
                                ...
                                className={cn(
                                  'text-white rounded-xl border p-4 cursor-pointer transition bg-primary hover:border-secondary-color hover:bg-white/20',
                                  active &&
